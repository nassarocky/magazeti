...
package tanzania.magazeti.magazeti.data;
...
import tanzania.magazeti.magazeti.FavoriteActivity;
...
public class FavoriteManager implements LocalItemManager<Favorite> {
    ...
    /**
     * {@link Intent#getAction()} for broadcasting getting favorites matching query
     */
    ...
    @VisibleForTesting static final String FILE_AUTHORITY = "tanzania.magazeti.magazeti.fileprovider";
                ...
                new LoaderManager.LoaderCallbacks<android.database.Cursor>() {
                    ...
                    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle args) {
                        if (!TextUtils.isEmpty(filter)) {
                            return new CursorLoader(context, filter);
                        }
