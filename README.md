## Materialistic for Magazeti
Material design [Magazeti] client for Android, uses official [HackerNews/API], [Dagger] for dependency injection and [Robolectric] for unit testing.
...
**Dependencies**
- [Official Magazeti API][HackerNews/API], user services (e.g. login/create account/vote/comment) rely on redirect requests to Magazeti website
- [Algolia Magazeti Search API]
...
[Magazeti]: https://news.ycombinator.com/
...
[Algolia Magazeti Search API]: https://github.com/algolia/hn-search
